...
var GraphQLClient = /** @class */ (function () {
    ...
    GraphQLClient.prototype.rawRequest = function (query, variables) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, headers, others, oHeaders, body, response, result, headers_1, status_1, errorResult;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.options, headers = _a.headers, others = __rest(_a, ["headers"]);
                        oHeaders = transformHeaders_1.default(headers);
    ...
    GraphQLClient.prototype.request = function (document, variables) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, headers, others, oHeaders, resolvedDoc, body, response, result, errorResult;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this.options, headers = _a.headers, others = __rest(_a, ["headers"]);
